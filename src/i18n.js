...
const copy = {
  zh: {
    ...
    heroNote: '五件作品，五种尺度：从日常成长、咖啡记录，到期权研究、AI 智能体技能，再到冲动消费冷冻箱。向下滚动，沿着时间线逐个进入。',
    stackHeading: '作品画廊',
    addProject: '添加项目',
    stackHint: '滚轮翻页 · 悬停展开',
  ...
  en: {
    ...
    heroNote: 'Five works at five scales: personal growth, coffee journaling, options research, AI agent skills, and an impulse-spending freezer. Scroll down to enter each one along the timeline.',
