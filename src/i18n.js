...
const copy = {
  zh: {
    ...
    heroNote: '四件作品，四种尺度：从日常成长、咖啡记录，到期权研究，再到 AI 智能体技能。向下滚动，沿着时间线逐个进入。',
    stackHeading: '作品画廊',
    addProject: '添加项目',
    stackHint: '滚轮翻页 · 悬停展开',
  ...
  en: {
    ...
    heroNote: 'Four works at four scales: personal growth, coffee journaling, options research, and AI agent skills. Scroll down to enter each one along the timeline.',
